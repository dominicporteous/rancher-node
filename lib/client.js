...
class RancherClient {
    ...
    getContainerStats(containerId) {
        Joi.assert(containerId, Joi.string().required(), 'Must specify container id');
        return this._request('get', `/v2-beta/projects/${this.environmentId}/container/${containerId}/stats`);
    }
    ...
    getContainers() {
        return this._request('get', `/v2-beta/projects/${this.environmentId}/containers`);
    }
